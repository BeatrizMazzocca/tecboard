...
## 🖥️ Demonstração
Projeto desenvolvido para fins de estudo e prática em front-end.
...
- Criar versão com dados dinâmicos

## 👩‍💻 Autora
Projeto desenvolvido por **Beatriz Mazzocca** durante curso de Front-end pela ALURA.
